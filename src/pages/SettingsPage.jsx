...
export default function SettingsPage() {
  ...
  return (
    <div className="min-h-screen bg-[#F8F5FF] text-zinc-100 font-sans pt-20 pb-20">
      ...
      <div className="max-w-6xl mx-auto px-4 lg:px-8">
        ...
        <header className="mb-12">
          <div className="flex items-center gap-4 mb-2">
            ...
            <div>
              <h1 className="text-4xl font-black text-slate-900 uppercase tracking-tight">Ayarlar</h1>
        ...
        <div className="flex flex-col lg:flex-row gap-12 items-start">
              ...
              {menuItems.map((item) => (
                <button
                  ...
                  className={`w-full flex items-center gap-4 px-6 py-3.5 rounded-2xl transition-all duration-300 group hover:scale-[1.02] active:scale-95 ${
                    activeTab === item.id 
                      ? 'bg-slate-900/50 text-slate-900 shadow-xl' 
                      : 'text-zinc-500 hover:text-slate-700'
                  }`}
                >
          ...
          {/* Main Content */}
          <main className="flex-1 w-full max-w-3xl bg-white/30 backdrop-blur-xl border border-zinc-800/50 rounded-[2rem] md:rounded-[2.5rem] p-6 md:p-12 shadow-2xl">
               ...
               <div className="space-y-12">
                  <section className="space-y-8">
                    <div className="flex items-center gap-3">
                       ...
                       <h2 className="text-xl font-black text-slate-900 uppercase tracking-tight">Profil Bilgileri</h2>
                    </div>
                    ...
                    <div className="p-6 md:p-8 rounded-[2rem] bg-zinc-950/50 border border-zinc-800/50 flex flex-col md:flex-row items-center gap-6 md:gap-8 group hover:border-purple-500/20 transition-all">
                       <div className="relative group/avatar shrink-0">
                          <div className="w-24 h-24 rounded-full bg-white border-2 border-zinc-800 overflow-hidden flex items-center justify-center">
                             {user?.avatar_url ? (
                          ...
                          <button aria-label="Profil fotoğrafını değiştir" className="absolute bottom-0 right-0 p-2 rounded-full bg-purple-600 text-slate-900 shadow-xl hover:scale-110 transition-transform">
                             <Camera size={16} />
                          </button>
                       </div>
                       <div className="flex-1 space-y-1 text-center md:text-left">
                          ...
                          <div className="flex items-center justify-center md:justify-start gap-2 mt-2">
                             <span className="px-3 py-1 rounded-full bg-white text-[10px] font-black uppercase tracking-widest text-slate-600 border border-zinc-800">{user?.role}</span>
               ...
               <div className="space-y-10">
                  <header className="space-y-2">
                    <div className="flex items-center gap-3">
                       ...
                       <h2 className="text-xl font-black text-slate-900 uppercase tracking-tight">Güvenlik Merkezi</h2>
                    </div>
                     ...
                     <div className="space-y-4 p-8 rounded-3xl bg-zinc-950/50 border border-zinc-800/50">
                        ...
                        <div className="space-y-3">
                           <input 
                             ...
                             className="w-full bg-zinc-950 border border-zinc-800 rounded-2xl py-4 px-6 text-slate-900 text-sm font-bold focus:border-purple-600 transition-all"
               ...
               <div className="space-y-10">
                  <header className="space-y-2">
                    <div className="flex items-center gap-3">
                       ...
                       <h2 className="text-xl font-black text-slate-900 uppercase tracking-tight">Bildirim Tercihleri</h2>
                    </div>
               ...
               <div className="space-y-10">
                  <header className="space-y-2">
                    <div className="flex items-center gap-3">
                       ...
                       <h2 className="text-xl font-black text-slate-900 uppercase tracking-tight">Gizlilik Ayarları</h2>
                    </div>
               ...
               <div className="space-y-10">
                  <header className="space-y-2">
                    <div className="flex items-center gap-3">
                       ...
                       <h2 className="text-xl font-black text-slate-900 uppercase tracking-tight">Görünüm Ayarları</h2>
                    </div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                     <button 
                       ...
                       className={`p-6 rounded-[2rem] border transition-all text-left space-y-3 ${appearanceSettings.theme === 'dark' ? 'bg-white border-purple-500/50' : 'bg-zinc-950/50 border-zinc-800 hover:border-zinc-700'}`}
                     >
                        <div className="w-10 h-10 rounded-xl bg-white border border-zinc-800 flex items-center justify-center text-zinc-500">
                           <ImageIcon size={20} />
                        </div>
                        <p className="text-xs font-black uppercase tracking-widest text-slate-900">Standart Koyu</p>
                     </button>
                     <button 
                       onClick={() => {
                     ...
                     >
                        ...
                        <p className="text-xs font-black uppercase tracking-widest text-slate-900">Ultra Siyah (AMOLED)</p>
                     </button>
                  </div>
               ...
               <div className="space-y-10">
                  <header className="space-y-2">
                    <div className="flex items-center gap-3">
                       ...
                       <h2 className="text-xl font-black text-slate-900 uppercase tracking-tight">MyAnimeList Entegrasyonu</h2>
                    </div>
                  ...
                  <div className="p-8 rounded-[2.5rem] bg-[#2E51A2]/10 border border-[#2E51A2]/20 space-y-6">
                     <div className="flex items-center gap-4">
                        <div className="w-12 h-12 rounded-2xl bg-[#2E51A2] flex items-center justify-center text-slate-900">
                           <span className="font-black text-xl italic">MAL</span>
                        </div>
                        <div className="flex-1">
                           <p className="text-sm font-bold text-slate-900">MyAnimeList Hesabın</p>
                     ...
                     <div className="space-y-4">
                        <input 
                           ...
                           className="w-full bg-zinc-950 border border-zinc-800 rounded-2xl py-4 px-6 text-slate-900 text-sm font-bold focus:border-[#2E51A2] transition-all"
                           value={malUsername}
                        ...
                        <button 
                           ...
                           disabled={isSaving}
                           className="w-full py-4 rounded-2xl bg-[#2E51A2] text-slate-900 text-xs font-black uppercase tracking-widest hover:bg-[#254182] transition-all shadow-lg shadow-[#2E51A2]/20"
                        >
    ...
    <div className="space-y-4">
       ...
       <div className="relative group">
          ...
          <button 
            ...
            className="absolute right-3 top-1/2 -translate-y-1/2 p-2 rounded-xl bg-purple-600 text-slate-900 shadow-lg disabled:opacity-0 transition-all hover:scale-110"
          >
