...
export default function Wallet() {
  ...
  useSEO({
    ...
    description: 'MahoraPeak sanal cüzdanınız. Aura Puanı bakiyenizi görüntüleyin ve yeni Aura Puanı satın alın.',
    url: 'https://mahorapeak.com.tr/cuzdan'
  });
        ...
        <div className="relative z-20 w-full max-w-[1400px] mx-auto px-4 sm:px-12 pt-28 pb-12 flex flex-col md:flex-row items-center md:items-end justify-between gap-8">
           <div className="text-center md:text-left">
             ...
             <p className="text-slate-300 text-lg max-w-xl font-medium drop-shadow-md mb-6">
               Aura, MahoraPeak ekosistemindeki sanal para birimidir. Aura ile özel profil efektleri, isim plakaları ve elit özellikler satın alabilirsiniz.
             </p>
