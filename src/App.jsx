...
// MAHORAPEAK_SİBER_GÜNCELLEME_V3_1741
  ...
  return (
    <div className="min-h-screen bg-[#070511] relative overflow-hidden font-sans flex items-center">
      ...
      <div className="absolute inset-0 z-0">
        <img 
          src="https://wsrv.nl/?url=https://mahorapeak.com.tr/bakim_arkaplanv2.png&w=1920&output=webp" 
          alt="Bakım" 
      ...
      <div className="absolute top-0 left-0 right-0 z-50 flex items-center justify-between p-6 lg:px-12 lg:pt-8">
        ...
        <div className="flex items-center gap-3">
          ...
          <a href="https://discord.gg/mahorapeak" target="_blank" rel="noreferrer" className="w-10 h-10 flex items-center justify-center rounded-xl bg-[#130E26]/90 backdrop-blur-md border border-[#6D28D9]/50 text-white hover:bg-[#130E26] hover:border-[#6D28D9] transition-all">
    ...
    <>
        ...
        <main id="main-content" className="min-h-screen bg-[#070511]">
          {isMaintenanceBlocked ? (
            ...
            <>
              {maintenanceMode && (
                 <div className="fixed top-0 left-0 right-0 z-[100] bg-gradient-to-r from-red-600 to-red-900 border-b border-red-500/50 text-white text-[10px] md:text-xs font-black py-1.5 uppercase tracking-widest shadow-lg flex items-center justify-center">
                    <div className="flex items-center justify-center text-center drop-shadow-md w-full px-4">
                        <span className="truncate">🚨 SİSTEM BAKIMDA - LÜTFEN YAPTIĞINIZ DEĞİŞİKLİKLERE DİKKAT EDİNİZ 🚨</span>
                    </div>
                 </div>
              )}
              {isAuthPage ? (
