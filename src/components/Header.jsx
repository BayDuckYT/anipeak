...
import {
  ...
  ChevronDown, Crown, CheckCheck, Zap, SendHorizontal, Award, Calendar, Star, Ghost, Sparkles, Gem, Wallet, ShoppingCart
} from 'lucide-react';
  ...
  return (
    <motion.header
      ...
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${
        scrolled ? 'header-solid-dark border-b border-white/5 shadow-2xl' : 'bg-transparent bg-gradient-to-b from-black/80 to-transparent'
      }`}
    >
          ...
          <Link to="/" className="flex items-center group flex-shrink-0 relative" aria-label="Ana Sayfa">
            <div className="relative">
              <img 
                ...
                width="200"
                height="80"
                className="h-16 md:h-20 w-auto object-contain drop-shadow-[0_0_15px_rgba(139,92,246,0.3)] group-hover:drop-shadow-[0_0_25px_rgba(139,92,246,0.6)] transition-all duration-300" 
                style={{ 
                    ...
                    >
                      ...
                      <div className="p-1.5">
                        ...
                        <Link
                          ...
                          className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-slate-300 hover:text-white hover:bg-white/5 transition-all text-sm group"
                        >
                          <ShoppingCart size={15} className="text-purple-400 group-hover:scale-110 transition-transform" />
                          Aura Market
                        </Link>
