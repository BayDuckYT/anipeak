    ...
    <div className={`inline-flex items-center gap-1.5 ${className}`}>
      {showCrown && isElite && (
        ...
        >
          ...
          <div className="absolute -top-10 left-1/2 -translate-x-1/2 bg-zinc-900 text-white text-[9px] font-black py-1.5 px-3 rounded-lg opacity-0 group-hover:opacity-100 transition-all pointer-events-none uppercase tracking-widest whitespace-nowrap border border-amber-500/50 z-[100] shadow-2xl scale-90 group-hover:scale-100 origin-bottom">
            PREMIUM ÜYE
          </div>
        </motion.button>
      )}
      ...
      {showGem && isStaff && (
        ...
        >
          ...
          <div className="absolute -top-10 left-1/2 -translate-x-1/2 bg-zinc-900 text-white text-[9px] font-black py-1.5 px-3 rounded-lg opacity-0 group-hover:opacity-100 transition-all pointer-events-none uppercase tracking-widest whitespace-nowrap border border-cyan-500/50 z-[100] shadow-2xl scale-90 group-hover:scale-100 origin-bottom">
            STAFF / YETKİLİ
          </div>
        </motion.button>
      )}
