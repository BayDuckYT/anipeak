...
export default function UserBadges({ user, showCrown = false, showGem = true, className = '', iconSize = 12 }) {
  ...
  const getPremiumIcon = () => {
    if (userData?.username === 'ANIPEAK' || planId === 'aethe') return <img src="/aethe.png" alt="Aethe" style={{ width: iconSize * 2.5, height: iconSize * 2.5, objectFit: 'contain' }} className="drop-shadow-[0_0_8px_rgba(244,63,94,0.6)] animate-pulse" />;
