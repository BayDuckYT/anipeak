          ...
          <AnimatePresence>
            {success && (
              ...
              >
                ...
                <p className="text-white font-bold text-lg">Hoş geldin, {form.username || form.email.split('@')[0]}! 🎉</p>
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <button
                  type="button"
                  onClick={() => {
                    registerUser('Google Kullanıcısı', 'google@anipeak.com', 'google');
                    login({ username: 'Google Kullanıcısı', email: 'google@anipeak.com', password: '' });
                    setSuccess(true);
